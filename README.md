...
To achieve our goals of accessible media– books, movies, articles, and images– we organized our data into three main categories: media, videos, and images; each of these categories all revolve around a common attribute: tags. Each of these are broken into separate tables, or relations, where there is a certain amount of criteria in each of these categories to be met that can identify its value and henceforth make it useful for any users of our app. 
